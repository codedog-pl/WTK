...
#define CORE                    cm7                 // Core specific include file name postfix.
#define MCU_PREFIX              stm32h757           // MCU specific include file name prefix.
#define HAL_PREFIX              stm32h7xx_hal       // MCU specific HAL include file name prefix.
...
#define WTK_OS_TASKS            128                 // The number of pre-allocated scheduled tasks, default 16.
